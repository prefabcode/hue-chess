...
function createOnboardingModal() {
  ...
  content.innerHTML = `
    ...
    <div class="scrollable dialog-content">
      ...
      <p>Each level requires 100 Hue Points, and every level features a unique chessboard theme. Journey through 18 distinct levels, discover 9 unique perks, complete the Hue Chess Challenge, and earn a special trophy for your profile page! (The trophy will only be visible to you.)</p>

...
export const TIPS = [
  "You can earn a bonus [2-3] hue points per win if you have 'Show Player Ratings' turned off in the lichess settings. This can be configured under Lichess preferences, display settings section.",
  "At level 12, you will unlock an extra perk slot.",
